    ...
    <div id="wrapper">
      ...
      <div class="form_div">
        ...
        <form action="db.php" method="post">
          ...
          <?php } ?>
          <input type="text" name="username_email" placeholder="Username or Email" class="my-1"><br />
          <input type="password" name="password" placeholder="Password" class="my-1"><br />
          <button name="login" class="btn btn-warning btn-lg my-1" type="submit">Login</button>
        </form>

        <p>
          <a href="register.php" class="btn btn-danger mt-2">Or, register here</a>
        </p>
      </div>
